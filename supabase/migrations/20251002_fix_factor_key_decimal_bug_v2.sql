...
DROP FUNCTION IF EXISTS public.calculate_factor_key(text, text, text, text, text, uuid, numeric, integer);
DROP FUNCTION IF EXISTS public.calculate_factor_key(text, text, text, text, text, uuid, text, numeric, integer);

-- Recréer LA fonction avec tous les paramètres
