-- Projection unique V1 pour index Algolia ef_all (FR uniquement mappé en _fr)
-- Crée la table de projection et les fonctions de rebuild/refresh par source

create table if not exists public.emission_factors_all_search (
