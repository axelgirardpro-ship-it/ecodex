-- Fix handle_new_user function to properly read user metadata
...
BEGIN
  ...
  -- Extract user metadata from raw_user_meta_data (priority) or user_metadata
  company_name := COALESCE(
    NEW.raw_user_meta_data ->> 'company',
    NEW.user_metadata ->> 'company',
