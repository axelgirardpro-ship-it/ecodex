-- Nettoyage des données résiduelles et création d'environnement de test (version corrigée)
...
-- 2. CRÉATION DE L'ENVIRONNEMENT DE TEST avec des IDs uniques

-- Créer les workspaces de test avec des IDs générés automatiquement
DO $$
DECLARE
    ...
    (user_supra_admin_id, 'test_environment_setup', 
     jsonb_build_object(
       ...
       'users', jsonb_build_object(
         'axelgirard.pro+dev@gmail.com', user_supra_admin_id,
         'axelgirard.pro@gmail.com', user_admin_premium_id,
         'axelgirard69@gmail.com', user_lecteur_freemium_id,
         'axelgirard69+1@gmail.com', user_lecteur_standard_id,
         'axelgirard69+2@gmail.com', user_gestionnaire_standard_id,
         'axelgirard69+3@gmail.com', user_admin_freemium_id,
         'axelgirard69+4@gmail.com', user_admin_standard_id
       )
     ));
END $$;