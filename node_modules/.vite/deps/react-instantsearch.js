...
function ResetScheduleSearch(_ref22) {
...
var _excluded10 = ["name", "escapedValue", "data", "path"];
  ...
  return function(widgetParams) {
    ...
    function _prepareFacetValues(facetValues) {
      return facetValues.slice(0, getLimit()).map(function(_ref22) {
        var label = _ref22.name, value = _ref22.escapedValue, data = _ref22.data, path = _ref22.path, subValue = _objectWithoutProperties9(_ref22, _excluded10);
...
function getStateWithoutPage(state) {
  var _ref = state || {}, page = _ref.page, rest = _objectWithoutProperties10(_ref, _excluded11);
  return rest;
}
...
var _excluded12 = ["name", "escapedValue", "path"];
      ...
      getWidgetRenderState: function getWidgetRenderState(renderOptions) {
        ...
        if (results) {
          ...
          items = transformItems(facetItems.slice(0, getLimit()).map(function(_ref3) {
            var label = _ref3.name, value = _ref3.escapedValue, path = _ref3.path, item = _objectWithoutProperties11(_ref3, _excluded12);
...
var _excluded13 = ["name", "escapedValue"];
...
var connectRefinementList = function connectRefinementList2(renderFn) {
  ...
  return function(widgetParams) {
    ...
    var formatItems = function formatItems2(_ref22) {
      var label = _ref22.name, value = _ref22.escapedValue, item = _objectWithoutProperties12(_ref22, _excluded13);
  ...
  walkIndex(rootIndex, function(widget) {
    ...
    if (searchResults || recommendResults) {
      ...
      initialResults[widget.getIndexId()] = _objectSpread46(_objectSpread46(_objectSpread46({}, searchResults && {
        state: _objectSpread46(_objectSpread46({}, searchResults._state), {}, {
...
var _excluded14 = ["listRef", "nextButtonRef", "previousButtonRef", "carouselIdRef", "classNames", "itemComponent", "previousIconComponent", "nextIconComponent", "items", "translations", "sendEvent"];
...
function createCarouselComponent(_ref3) {
  ...
  return function Carousel2(userProps) {
    var listRef = userProps.listRef, nextButtonRef = userProps.nextButtonRef, previousButtonRef = userProps.previousButtonRef, carouselIdRef = userProps.carouselIdRef, _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, _userProps$itemCompon = userProps.itemComponent, ItemComponent = _userProps$itemCompon === void 0 ? createDefaultItemComponent({
      ...
      Fragment: Fragment9
    }) : _userProps$itemCompon, _userProps$previousIc = userProps.previousIconComponent, PreviousIconComponent = _userProps$previousIc === void 0 ? PreviousIconDefaultComponent : _userProps$previousIc, _userProps$nextIconCo = userProps.nextIconComponent, NextIconComponent = _userProps$nextIconCo === void 0 ? NextIconDefaultComponent : _userProps$nextIconCo, items = userProps.items, userTranslations = userProps.translations, sendEvent = userProps.sendEvent, props = _objectWithoutProperties13(userProps, _excluded14);
    ...
    return createElement8("div", _extends({}, props, {
...
var _excluded15 = ["classNames", "emptyComponent", "headerComponent", "itemComponent", "layout", "items", "status", "translations", "sendEvent"];
...
function createFrequentlyBoughtTogetherComponent(_ref) {
  ...
  return function FrequentlyBoughtTogether2(userProps) {
    var _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, _userProps$emptyCompo = userProps.emptyComponent, EmptyComponent = _userProps$emptyCompo === void 0 ? createDefaultEmptyComponent({
      ...
      createElement: createElement8,
      Fragment: Fragment9
    }) : _userProps$layout, items = userProps.items, status = userProps.status, userTranslations = userProps.translations, sendEvent = userProps.sendEvent, props = _objectWithoutProperties13(userProps, _excluded15);
    ...
    if (items.length === 0 && status === "idle") {
      return createElement8("section", _extends({}, props, {
...
function createHighlightComponent(_ref3) {
  ...
  return function Highlight3(userProps) {
    var parts = userProps.parts, _userProps$highlighte = userProps.highlightedTagName, highlightedTagName = _userProps$highlighte === void 0 ? "mark" : _userProps$highlighte, _userProps$nonHighlig = userProps.nonHighlightedTagName, nonHighlightedTagName = _userProps$nonHighlig === void 0 ? "span" : _userProps$nonHighlig, _userProps$separator = userProps.separator, separator = _userProps$separator === void 0 ? ", " : _userProps$separator, className = userProps.className, _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, props = _objectWithoutProperties13(userProps, _excluded16);
    return createElement8("span", _extends({}, props, {
...
var _excluded17 = ["classNames", "hits", "itemComponent", "sendEvent", "emptyComponent", "banner", "bannerComponent"];
...
function createHitsComponent(_ref3) {
  ...
  return function Hits2(userProps) {
    var _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, hits = userProps.hits, ItemComponent = userProps.itemComponent, sendEvent = userProps.sendEvent, EmptyComponent = userProps.emptyComponent, banner = userProps.banner, BannerComponent = userProps.bannerComponent, props = _objectWithoutProperties13(userProps, _excluded17);
    return createElement8("div", _extends({}, props, {
...
var _excluded20 = ["classNames", "emptyComponent", "headerComponent", "itemComponent", "layout", "items", "status", "translations", "sendEvent"];
...
function createTrendingItemsComponent(_ref) {
  ...
  return function TrendingItems2(userProps) {
    var _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, _userProps$emptyCompo = userProps.emptyComponent, EmptyComponent = _userProps$emptyCompo === void 0 ? createDefaultEmptyComponent({
      ...
      createElement: createElement8,
      Fragment: Fragment9
    }) : _userProps$layout, items = userProps.items, status = userProps.status, userTranslations = userProps.translations, sendEvent = userProps.sendEvent, props = _objectWithoutProperties13(userProps, _excluded20);
...
// node_modules/react-instantsearch/dist/es/ui/Breadcrumb.js
var _excluded21 = ["classNames", "items", "hasItems", "createURL", "onNavigate", "separator", "translations"];
function _extends3() {
...
function Breadcrumb(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, _ref$items = _ref.items, items = _ref$items === void 0 ? [] : _ref$items, hasItems = _ref.hasItems, createURL = _ref.createURL, onNavigate = _ref.onNavigate, _ref$separator = _ref.separator, separator = _ref$separator === void 0 ? ">" : _ref$separator, translations = _ref.translations, props = _objectWithoutProperties14(_ref, _excluded21);
...
var _excluded26 = ["attributes", "rootPath", "separator", "transformItems", "translations"];
function _extends4() {
...
function Breadcrumb2(_ref) {
  var attributes = _ref.attributes, rootPath = _ref.rootPath, separator = _ref.separator, transformItems = _ref.transformItems, translations = _ref.translations, props = _objectWithoutProperties15(_ref, _excluded26);
...
var _excluded27 = ["classNames", "disabled", "onClick", "translations"];
function _extends5() {
...
function ClearRefinements(_ref) {
  ...
  } : _ref$onClick, translations = _ref.translations, props = _objectWithoutProperties16(_ref, _excluded27);
...
var _excluded28 = ["includedAttributes", "excludedAttributes", "transformItems", "translations"];
function _extends6() {
...
function ClearRefinements2(_ref) {
  var includedAttributes = _ref.includedAttributes, excludedAttributes = _ref.excludedAttributes, transformItems = _ref.transformItems, translations = _ref.translations, props = _objectWithoutProperties17(_ref, _excluded28);
...
// node_modules/react-instantsearch/dist/es/ui/CurrentRefinements.js
var _excluded29 = ["classNames", "items", "hasRefinements"];
function _extends7() {
...
function CurrentRefinements(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, _ref$items = _ref.items, items = _ref$items === void 0 ? [] : _ref$items, _ref$hasRefinements = _ref.hasRefinements, hasRefinements = _ref$hasRefinements === void 0 ? false : _ref$hasRefinements, props = _objectWithoutProperties18(_ref, _excluded29);
...
// node_modules/react-instantsearch/dist/es/widgets/CurrentRefinements.js
var _excluded30 = ["includedAttributes", "excludedAttributes", "transformItems"];
function _extends8() {
...
function CurrentRefinements2(_ref) {
  var includedAttributes = _ref.includedAttributes, excludedAttributes = _ref.excludedAttributes, transformItems = _ref.transformItems, props = _objectWithoutProperties19(_ref, _excluded30);
...
var _excluded31 = ["objectIDs", "limit", "threshold", "queryParameters", "escapeHTML", "transformItems", "itemComponent", "headerComponent", "emptyComponent", "layoutComponent"];
function _extends9() {
...
function FrequentlyBoughtTogether(_ref) {
  ...
  var _itemComponent = (0, import_react32.useMemo)(function() {
    return itemComponent ? function(itemProps) {
      return itemComponent(_objectSpread54(_objectSpread54({}, itemProps), {}, {
        sendEvent
      }));
    } : void 0;
...
var _excluded32 = ["isShowingMore", "translations"];
...
function ShowMoreButton(_ref) {
  var isShowingMore = _ref.isShowingMore, translations = _ref.translations, props = _objectWithoutProperties21(_ref, _excluded32);
...
// node_modules/react-instantsearch/dist/es/ui/HierarchicalMenu.js
var _excluded33 = ["classNames", "items", "hasItems", "onNavigate", "createURL", "showMore", "canToggleShowMore", "onToggleShowMore", "isShowingMore", "translations"];
function _extends10() {
...
var _excluded34 = ["attributes", "limit", "rootPath", "separator", "showMore", "showMoreLimit", "showParentLevel", "sortBy", "transformItems", "translations"];
function _extends11() {
...
function Highlight(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, props = _objectWithoutProperties24(_ref, _excluded35);
...
// node_modules/react-instantsearch/dist/es/widgets/Highlight.js
var _excluded36 = ["hit", "attribute", "highlightedTagName", "nonHighlightedTagName", "separator"];
function _extends13() {
...
function Highlight2(_ref) {
  var hit = _ref.hit, attribute = _ref.attribute, highlightedTagName = _ref.highlightedTagName, nonHighlightedTagName = _ref.nonHighlightedTagName, separator = _ref.separator, props = _objectWithoutProperties25(_ref, _excluded36);
...
var _excluded37 = ["escapeHTML", "transformItems", "hitComponent", "bannerComponent"];
...
function Hits(_ref22) {
  var escapeHTML = _ref22.escapeHTML, transformItems = _ref22.transformItems, _ref2$hitComponent = _ref22.hitComponent, HitComponent = _ref2$hitComponent === void 0 ? DefaultHitComponent : _ref2$hitComponent, BannerComponent = _ref22.bannerComponent, props = _objectWithoutProperties26(_ref22, _excluded37);
...
var _excluded38 = ["items", "onChange", "currentValue", "classNames"];
function _extends15() {
...
function HitsPerPage(_ref) {
  var items = _ref.items, _onChange = _ref.onChange, currentValue = _ref.currentValue, _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, props = _objectWithoutProperties27(_ref, _excluded38);
...
// node_modules/react-instantsearch/dist/es/widgets/HitsPerPage.js
var _excluded39 = ["items", "transformItems"];
function _extends16() {
...
function HitsPerPage2(_ref) {
  var userItems = _ref.items, transformItems = _ref.transformItems, props = _objectWithoutProperties28(_ref, _excluded39);
...
var _excluded40 = ["hitComponent", "hits", "bannerComponent", "banner", "sendEvent", "isFirstPage", "isLastPage", "onShowPrevious", "onShowMore", "classNames", "translations"];
function _extends17() {
...
var _excluded41 = ["showPrevious", "cache", "escapeHTML", "transformItems", "translations", "bannerComponent"];
function _extends18() {
...
function _toPropertyKey53(t) {
  ...
  return "symbol" == _typeof59(i) ? i : String(i);
}
...
function InfiniteHits2(_ref) {
  var _ref$showPrevious = _ref.showPrevious, shouldShowPrevious = _ref$showPrevious === void 0 ? true : _ref$showPrevious, cache = _ref.cache, escapeHTML = _ref.escapeHTML, transformItems = _ref.transformItems, translations = _ref.translations, BannerComponent = _ref.bannerComponent, props = _objectWithoutProperties30(_ref, _excluded41);
...
var _excluded42 = ["items", "classNames", "showMore", "canToggleShowMore", "onToggleShowMore", "isShowingMore", "createURL", "onRefine", "translations"];
function _extends19() {
...
var _excluded43 = ["attribute", "limit", "showMore", "showMoreLimit", "sortBy", "transformItems", "translations"];
function _extends20() {
...
function _toPropertyKey54(t) {
  ...
  return "symbol" == _typeof60(i) ? i : String(i);
}
...
function Menu2(_ref) {
  var attribute = _ref.attribute, limit = _ref.limit, showMore = _ref.showMore, showMoreLimit = _ref.showMoreLimit, sortBy = _ref.sortBy, transformItems = _ref.transformItems, translations = _ref.translations, props = _objectWithoutProperties32(_ref, _excluded43);
...
var _excluded44 = ["pages", "currentPage", "nbPages", "isFirstPage", "isLastPage", "showFirst", "showPrevious", "showNext", "showLast", "createURL", "onNavigate", "translations", "classNames"];
...
function Pagination(_ref) {
  var pages = _ref.pages, currentPage = _ref.currentPage, nbPages = _ref.nbPages, isFirstPage = _ref.isFirstPage, isLastPage = _ref.isLastPage, _ref$showFirst = _ref.showFirst, showFirst = _ref$showFirst === void 0 ? true : _ref$showFirst, _ref$showPrevious = _ref.showPrevious, showPrevious = _ref$showPrevious === void 0 ? true : _ref$showPrevious, _ref$showNext = _ref.showNext, showNext = _ref$showNext === void 0 ? true : _ref$showNext, _ref$showLast = _ref.showLast, showLast = _ref$showLast === void 0 ? true : _ref$showLast, createURL = _ref.createURL, onNavigate = _ref.onNavigate, translations = _ref.translations, _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, props = _objectWithoutProperties33(_ref, _excluded44);
...
var _excluded45 = ["showFirst", "showPrevious", "showNext", "showLast", "padding", "totalPages", "translations"];
function _extends22() {
...
function _toPropertyKey55(t) {
  ...
  return "symbol" == _typeof61(i) ? i : String(i);
}
...
function Pagination2(_ref) {
  var showFirst = _ref.showFirst, showPrevious = _ref.showPrevious, showNext = _ref.showNext, showLast = _ref.showLast, padding = _ref.padding, totalPages = _ref.totalPages, translations = _ref.translations, props = _objectWithoutProperties34(_ref, _excluded45);
...
var _excluded46 = ["classNames", "url", "theme"];
function _extends23() {
...
function PoweredBy(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, url = _ref.url, _ref$theme = _ref.theme, theme = _ref$theme === void 0 ? "light" : _ref$theme, props = _objectWithoutProperties35(_ref, _excluded46);
...
var _excluded47 = ["classNames", "range", "start", "step", "disabled", "onSubmit", "translations"];
function _extends25() {
...
var _excluded48 = ["attribute", "min", "max", "precision", "translations"];
function _extends26() {
...
function _toPropertyKey56(t) {
  ...
  return "symbol" == _typeof62(i) ? i : String(i);
}
...
function RangeInput2(_ref) {
  var attribute = _ref.attribute, min = _ref.min, max = _ref.max, precision = _ref.precision, translations = _ref.translations, props = _objectWithoutProperties37(_ref, _excluded48);
...
var _excluded49 = ["canRefine", "items", "onRefine", "query", "searchBox", "noResults", "showMore", "canToggleShowMore", "onToggleShowMore", "isShowingMore", "className", "classNames", "translations"];
function _extends27() {
...
var _excluded50 = ["formRef", "inputRef", "isSearchStalled", "onChange", "onReset", "onSubmit", "placeholder", "value", "autoFocus", "resetIconComponent", "submitIconComponent", "loadingIconComponent", "classNames", "translations"];
function _extends28() {
...
function SearchBox(_ref7) {
  var formRef = _ref7.formRef, inputRef = _ref7.inputRef, isSearchStalled = _ref7.isSearchStalled, onChange = _ref7.onChange, onReset = _ref7.onReset, onSubmit = _ref7.onSubmit, _ref7$placeholder = _ref7.placeholder, placeholder = _ref7$placeholder === void 0 ? "" : _ref7$placeholder, value = _ref7.value, autoFocus = _ref7.autoFocus, _ref7$resetIconCompon = _ref7.resetIconComponent, ResetIcon = _ref7$resetIconCompon === void 0 ? DefaultResetIcon : _ref7$resetIconCompon, _ref7$submitIconCompo = _ref7.submitIconComponent, SubmitIcon = _ref7$submitIconCompo === void 0 ? DefaultSubmitIcon : _ref7$submitIconCompo, _ref7$loadingIconComp = _ref7.loadingIconComponent, LoadingIcon = _ref7$loadingIconComp === void 0 ? DefaultLoadingIcon : _ref7$loadingIconComp, _ref7$classNames = _ref7.classNames, classNames = _ref7$classNames === void 0 ? {} : _ref7$classNames, translations = _ref7.translations, props = _objectWithoutProperties39(_ref7, _excluded50);
...
// node_modules/react-instantsearch/dist/es/widgets/RefinementList.js
function _typeof63(o) {
  "@babel/helpers - typeof";
  return _typeof63 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  } : function(o2) {
    return o2 && "function" == typeof Symbol && o2.constructor === Symbol && o2 !== Symbol.prototype ? "symbol" : typeof o2;
  }, _typeof63(o);
}
var _excluded51 = ["searchable", "searchablePlaceholder", "searchableSelectOnSubmit", "attribute", "operator", "limit", "showMore", "showMoreLimit", "sortBy", "escapeFacetValues", "transformItems", "translations"];
function _extends29() {
...
function _toPropertyKey57(t) {
  ...
  return "symbol" == _typeof63(i) ? i : String(i);
}
function _toPrimitive57(t, r) {
  ...
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof63(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
...
function _typeof64(o) {
  "@babel/helpers - typeof";
  return _typeof64 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  } : function(o2) {
    return o2 && "function" == typeof Symbol && o2.constructor === Symbol && o2 !== Symbol.prototype ? "symbol" : typeof o2;
  }, _typeof64(o);
}
var _excluded52 = ["objectIDs", "limit", "threshold", "fallbackParameters", "queryParameters", "escapeHTML", "transformItems", "itemComponent", "headerComponent", "emptyComponent", "layoutComponent"];
function _extends30() {
...
function _toPropertyKey58(t) {
  ...
  return "symbol" == _typeof64(i) ? i : String(i);
}
function _toPrimitive58(t, r) {
  ...
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof64(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
...
function RelatedProducts(_ref) {
  var objectIDs = _ref.objectIDs, limit = _ref.limit, threshold = _ref.threshold, fallbackParameters = _ref.fallbackParameters, queryParameters = _ref.queryParameters, escapeHTML = _ref.escapeHTML, transformItems = _ref.transformItems, itemComponent = _ref.itemComponent, headerComponent = _ref.headerComponent, emptyComponent = _ref.emptyComponent, layoutComponent = _ref.layoutComponent, props = _objectWithoutProperties41(_ref, _excluded52);
  var _useInstantSearch = useInstantSearch(), status = _useInstantSearch.status;
  ...
  var _itemComponent = (0, import_react55.useMemo)(function() {
    return itemComponent ? function(itemProps) {
      return itemComponent(_objectSpread61(_objectSpread61({}, itemProps), {}, {
        sendEvent
      }));
    } : void 0;
  }, [itemComponent, sendEvent]);
...
function _typeof65(o) {
  "@babel/helpers - typeof";
  return _typeof65 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  } : function(o2) {
    return o2 && "function" == typeof Symbol && o2.constructor === Symbol && o2 !== Symbol.prototype ? "symbol" : typeof o2;
  }, _typeof65(o);
}
var _excluded53 = ["queryHook", "searchAsYouType", "ignoreCompositionEvents", "translations"];
function _extends31() {
...
function _objectSpread62(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys62(Object(t)).forEach(function(r2) {
      Object.defineProperty(e, r2, Object.getOwnPropertyDescriptor(t, r2));
    });
  }
  return e;
...
function _toPropertyKey59(t) {
  ...
  return "symbol" == _typeof65(i) ? i : String(i);
}
function _toPrimitive59(t, r) {
  ...
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof65(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
...
function Snippet(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, props = _objectWithoutProperties43(_ref, _excluded54);
...
// node_modules/react-instantsearch/dist/es/widgets/Snippet.js
var _excluded55 = ["hit", "attribute", "highlightedTagName", "nonHighlightedTagName", "separator"];
function _extends33() {
...
function Snippet2(_ref) {
  var hit = _ref.hit, attribute = _ref.attribute, highlightedTagName = _ref.highlightedTagName, nonHighlightedTagName = _ref.nonHighlightedTagName, separator = _ref.separator, props = _objectWithoutProperties44(_ref, _excluded55);
...
var _excluded56 = ["items", "value", "onChange", "classNames"];
function _extends34() {
...
function SortBy(_ref) {
  ...
  } : _ref$onChange, _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, props = _objectWithoutProperties45(_ref, _excluded56);
...
// node_modules/react-instantsearch/dist/es/widgets/SortBy.js
var _excluded57 = ["items", "transformItems"];
function _extends35() {
...
function SortBy2(_ref) {
  var items = _ref.items, transformItems = _ref.transformItems, props = _objectWithoutProperties46(_ref, _excluded57);
...
var _excluded58 = ["classNames", "nbHits", "processingTimeMS", "nbSortedHits", "areHitsSorted", "translations"];
function _extends36() {
...
function Stats(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, nbHits = _ref.nbHits, processingTimeMS = _ref.processingTimeMS, nbSortedHits = _ref.nbSortedHits, areHitsSorted = _ref.areHitsSorted, translations = _ref.translations, props = _objectWithoutProperties47(_ref, _excluded58);
...
// node_modules/react-instantsearch/dist/es/widgets/Stats.js
function _typeof66(o) {
  "@babel/helpers - typeof";
  return _typeof66 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  } : function(o2) {
    return o2 && "function" == typeof Symbol && o2.constructor === Symbol && o2 !== Symbol.prototype ? "symbol" : typeof o2;
  }, _typeof66(o);
}
var _excluded59 = ["translations"];
function _extends37() {
...
function _objectSpread63(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys63(Object(t)).forEach(function(r2) {
      Object.defineProperty(e, r2, Object.getOwnPropertyDescriptor(t, r2));
    });
  }
  return e;
...
function _toPropertyKey60(t) {
  ...
  return "symbol" == _typeof66(i) ? i : String(i);
}
function _toPrimitive60(t, r) {
  ...
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof66(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
...
function Stats2(_ref) {
  var translations = _ref.translations, props = _objectWithoutProperties48(_ref, _excluded59);
...
var _excluded60 = ["classNames", "checked", "onChange", "label"];
function _extends38() {
...
function ToggleRefinement(_ref) {
  var _ref$classNames = _ref.classNames, classNames = _ref$classNames === void 0 ? {} : _ref$classNames, checked = _ref.checked, _onChange = _ref.onChange, label = _ref.label, props = _objectWithoutProperties49(_ref, _excluded60);
...
// node_modules/react-instantsearch/dist/es/widgets/ToggleRefinement.js
var _excluded61 = ["attribute", "on", "off"];
function _extends39() {
...
function ToggleRefinement2(_ref) {
  var attribute = _ref.attribute, on = _ref.on, off = _ref.off, props = _objectWithoutProperties50(_ref, _excluded61);
...
function _typeof67(o) {
  "@babel/helpers - typeof";
  return _typeof67 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  } : function(o2) {
    return o2 && "function" == typeof Symbol && o2.constructor === Symbol && o2 !== Symbol.prototype ? "symbol" : typeof o2;
  }, _typeof67(o);
}
var _excluded62 = ["facetName", "facetValue", "limit", "threshold", "fallbackParameters", "queryParameters", "escapeHTML", "transformItems", "itemComponent", "headerComponent", "emptyComponent", "layoutComponent"];
function _extends40() {
...
function _objectSpread64(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys64(Object(t)).forEach(function(r2) {
      Object.defineProperty(e, r2, Object.getOwnPropertyDescriptor(t, r2));
    });
  }
  return e;
...
function _toPropertyKey61(t) {
  ...
  return "symbol" == _typeof67(i) ? i : String(i);
}
function _toPrimitive61(t, r) {
  ...
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof67(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
...
function TrendingItems(_ref) {
  var facetName = _ref.facetName, facetValue = _ref.facetValue, limit = _ref.limit, threshold = _ref.threshold, fallbackParameters = _ref.fallbackParameters, queryParameters = _ref.queryParameters, escapeHTML = _ref.escapeHTML, transformItems = _ref.transformItems, itemComponent = _ref.itemComponent, headerComponent = _ref.headerComponent, emptyComponent = _ref.emptyComponent, layoutComponent = _ref.layoutComponent, props = _objectWithoutProperties51(_ref, _excluded62);
  ...
  var _itemComponent = (0, import_react65.useMemo)(function() {
    return itemComponent ? function(itemProps) {
      return itemComponent(_objectSpread64(_objectSpread64({}, itemProps), {}, {
        sendEvent
      }));
    } : void 0;
  }, [itemComponent, sendEvent]);
...
function _typeof68(o) {
  "@babel/helpers - typeof";
  return _typeof68 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  } : function(o2) {
    return o2 && "function" == typeof Symbol && o2.constructor === Symbol && o2 !== Symbol.prototype ? "symbol" : typeof o2;
  }, _typeof68(o);
}
var _excluded63 = ["objectIDs", "limit", "threshold", "queryParameters", "fallbackParameters", "escapeHTML", "transformItems", "itemComponent", "headerComponent", "emptyComponent", "layoutComponent"];
function _extends41() {
...
function _objectSpread65(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? ownKeys65(Object(t), true).forEach(function(r2) {
      _defineProperty63(e, r2, t[r2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys65(Object(t)).forEach(function(r2) {
      Object.defineProperty(e, r2, Object.getOwnPropertyDescriptor(t, r2));
    });
  }
  return e;
...
function _toPropertyKey62(t) {
  ...
  return "symbol" == _typeof68(i) ? i : String(i);
}
function _toPrimitive62(t, r) {
  ...
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof68(i)) return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
}
...
function LookingSimilar(_ref) {
  ...
  var _itemComponent = (0, import_react66.useMemo)(function() {
    return itemComponent ? function(itemProps) {
      return itemComponent(_objectSpread65(_objectSpread65({}, itemProps), {}, {
        sendEvent
      }));
    } : void 0;
  }, [itemComponent, sendEvent]);
